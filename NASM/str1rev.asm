;Deklarasi procedure external (winapi)
...
SEGMENT .DATA use32
judul   	db "KONVERSI KE HURUF BESAR",0 

msg1 		db 13,10,"TULIS KALIMAT   : ",0
msg1_len 	dd $-msg1

msg2 		db 13,10,"DIUBAH KE BESAR : ",0
msg2_len 	dd $-msg2
