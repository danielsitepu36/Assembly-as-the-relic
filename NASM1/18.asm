...
SEGMENT .DATA use32
Title   	db "NOTHING HERE",0 

msg0 		db 13,10,"ANONYMOUS",0
msg0_len 	dd $-msg0
...
push dword [msg01_len] 	;; parameter ke 3 panjang string
push dword msg01			;; parameter ke 2 string yang akan ditampilkan
