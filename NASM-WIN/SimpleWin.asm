...
mov dword [CommandLine], eax 
								...
								;; Fungsi WindowMain() perlu 4 paramater: hInstance, 0, CommandLine, SW_SHOWDEFAULT 
								;; SW_<something> = Windows constant for how to show a window. 
...
WindowMain: 
								...
								;; window class structure. MSG is 28 bytes in size; let's use [ebp-48-24] = [ebp-72] for that.
								;; Then there's HWND, which is 4 bytes in size. 
